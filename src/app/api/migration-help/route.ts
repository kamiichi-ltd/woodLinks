...
export async function GET() {
  ...
  await supabase.rpc('increment_wood_view', { slug_input: 'dummy' })
  ...
  return NextResponse.json({ message: "Please run 002_add_views_column.sql in Supabase SQL Editor", sql })
}
